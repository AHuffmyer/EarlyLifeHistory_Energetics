...
CURRENTLY LOADED THE DATA FILES ABOVE DIRECTLY INTO METABOANALYST TO OUTPUT AN ENRICHMENT (METABOLITE CLASS) AND A PATHWAY TABLE
...
Conduct analysis for Cluster 1 and save data frame with KEGG terms.  
