...
Plot data as a scatterplot   
```{r}
sym_counts$code<-paste(sym_counts$lifestage, "\n (", sym_counts$hpf, ")")
sym_counts$code <- factor(sym_counts$code,levels = c("Egg Fertilized \n ( 1 )", "Embryo 1 \n ( 5 )", "Larvae 1 \n ( 38 )", "Larvae 2 \n ( 65 )", "Larvae 3 \n ( 93 )", "Larvae 4 \n ( 163 )", "Larvae 5 \n ( 183 )", "Recruit 1 \n ( 183 )", "Larvae 6 \n ( 231 )", "Recruit 2 \n ( 231 )", "Plug 1 \n ( 183 )", "Plug 2 \n ( 231 )", "Plug 3 \n ( 255 )"))
...
cells_size_plot<-corr %>%
    ...
    xlab("Hours Post-Fertilization") + 
    scale_fill_manual(name="Lifestage", values=c("#BA55D3", "#8C510A", "#DFC27D","#80CDC1", "#003C30"), guide="none")+
    scale_color_manual(name="Lifestage", values=c("#BA55D3", "#8C510A", "#DFC27D","#80CDC1", "#003C30"))+
...
cells_size_plot<-cells_size_plot+theme(legend.position="none")

#assemble plots
all_plots<-plot_grid(size_plot2, symb_plot2, cells_size_plot, r_corr_plot, labels = c("A", "B", "C", "D"), label_size=18, ncol=4, nrow=1, rel_heights= c(1,1,1,1), rel_widths = c(1,1,1,1), align="h")

all_plots_legend<-plot_grid(all_plots, legend, rel_widths = c(4, 0.5), ncol=2, nrow=1)

ggsave(file="Mcap2020/Figures/Physiology/Physiology_figure.pdf", all_plots_legend, dpi=300, width=20, height=6, units="in")
```
