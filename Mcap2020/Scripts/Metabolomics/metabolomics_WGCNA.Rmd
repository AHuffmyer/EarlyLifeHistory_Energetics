...
```{r}
carbmetab<-c("Glucose", "Sucrose", "Fructose", "Pyruvate")
...
signal_metab$Function<-c("Signaling")
...
```{r}
nitrogen <-c("Glutamate", "Arginine", "Ornithine", "Tyrosine", "Phenylalanine", "Glutamine")
...
fattyacid_metab$Function<-c("Fatty Acid Metabolism")
...
```{r}
specific_metab<-rbind(carbmetab_metab, fattyacid_metab, lipid_metab, nitrogen_metab, signal_metab)
```
...
metab_plots<-plot_grid(carbon_plot, nitrogen_plot, ncol=2, nrow=1, align="h")
                      
ggsave(filename="Mcap2020/Figures/Metabolomics/metabolite_expression_class.pdf", plot=metab_plots, dpi=300, width=10, height=4, units="in")
```