...
```{r}
all<-geneInfo%>%
  dplyr::select(gene_id, Length, GO_IDs)
```
...
module_list<-geneInfo%>%
  dplyr::select(gene_id, Length, GO_IDs, Module)
...
GO_all.BP <-  ggplot(go_all, aes(x = Pattern, y = term)) + 
  ...
  facet_grid(GOSlim_bin ~ ., scales = "free", space= "free", shrink=TRUE, labeller = label_wrap_gen(width=30, multi_line = TRUE))+
  scale_colour_manual(name="Ontogenetic Pattern", values = c("High Early in Development"="#DFC27D", "High in Mid Development"="#80CDC1", "High Late in Development"="#BA55D3")) +
...
ggsave(filename="Mcap2020/Figures/TagSeq/GOSeq/Patterns/GOenrich_all_patterns_BP.png", plot=GO_all.BP, dpi=50, width=30, height=35, units="in")
```
...
ggsave(filename="Mcap2020/Figures/TagSeq/GOSeq/Patterns/GOenrich_all_patterns_MF.png", plot=GO_all.MF, dpi=50 , width=40, height=45, units="in") 
```
