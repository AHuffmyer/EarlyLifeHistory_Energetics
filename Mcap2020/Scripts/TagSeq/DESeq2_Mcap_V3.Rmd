...
ggsave("Mcap2020/Figures/TagSeq/DESeq/PCA_all_genes.pdf", allgenesfilt_PCA_visual, width=8, height=5)
```
...
```{r}
dev.off()
pdf("Mcap2020/Figures/TagSeq/DESeq/DEG_heatmap_development.pdf", width=12, height=14)
...
ggsave("Mcap2020/Figures/TagSeq/DESeq/PCA_DEG.pdf", DEG_PCA, width=8, height=5)
```
...
write_csv(deg_results_list, "Mcap2020/Output/TagSeq/DESeq/deg_list.csv")
...
write_csv(file="Mcap2020/Output/TagSeq/DESeq/all_genes.csv", all_genes)
```
...
9072 genes clusters with cluster size >15 (98.8% of all DEGs were clustered) - proceeding with cluster minimum size = 15
...
ggsave(cluster_plot, filename="Mcap2020/Figures/TagSeq/DESeq/cluster_plot.pdf", width=12, height=10)
```
...
ggsave(cluster_plot2, filename="Mcap2020/Figures/TagSeq/DESeq/cluster_plot_patterns.pdf", width=7, height=3.5)
```
...
ggsave(plot=deg_FC, "Mcap2020/Figures/TagSeq/DESeq/DEG_foldchange.pdf", height=4, width=4)
```
