...
### Identify modules using BlockWise Modules 

We will also try using blockwiseModules to identify modules of genes and will analyze all modules in one "block".     
...
netwk <- blockwiseModules(datExpr,                            # <= input here
                          ...
                          minModuleSize = 30,                  #minimum size of module (# genes)
                          maxBlockSize = 13000,                 #maximum size of blocks (analyze all in one block)
...
pdf("Mcap2020/Figures/TagSeq/blockwise_module_colors.pdf")
plotDendroAndColors(
  netwk$dendrograms[[1]],
...
```
   ...
   0    1    2    3    4    5    6    7    8 
1204 3536 2862 2725  720  541  372  165  112 

Blockwise also gives us 8 modules, dynamic tree cut gives us 8 modules. Blockwise modules has more genes in the modules than dynamic tree cut. 
