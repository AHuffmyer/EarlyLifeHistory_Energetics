...
target_plots_legend<-plot_grid(target_plots, legend, rel_widths = c(4, 1.2), ncol=2, nrow=1)
...
target_plots_legend2<-plot_grid(target_plots2, legend, rel_widths = c(4, 1.2), ncol=2, nrow=1)

ggsave(file="Mcap2020/Figures/Physiology/Physiology_figure_densities_volume.png", target_plots_legend2, dpi=300, width=8, height=6, units="in")
