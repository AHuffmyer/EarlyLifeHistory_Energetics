...
Load in dataframe with gene annotation information.  
```{r}
head(geneInfo)
```

From our Gene Info data frame, extract a list of gene names with specific functions of interest.  
...
```{r}
specific_genes<-rbind(carbanhyd_genes, glycsyn_genes, ammontr_genes, glutperox_genes, atpase_genes, glucosehomeo_genes, apoptosis_genes, communication_genes, carbs_genes)
```
...
lifestage_order<-c("Egg (1 hpf)", "Embryo (5 hpf)", "Embryo (38 hpf)", "Embryo (65 hpf)", "Larvae (93 hpf)", "Larvae (163 hpf)", "Larvae (231 hpf)", "Metamorphosed Recruit (231 hpf)", "Attached Recruit (183 hpf)", "Attached Recruit (231 hpf)")
...
atpase_plot<-specific_genes%>%
  ...
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem), width=0.1, linetype="solid", color="black", position=position_dodge(0.1), size=0.5) + 
    ...
    ylim(5.5,6)+
    theme_classic() + 
    geom_text(x=1.5, y=5.5, label="N=54 genes", size=4, fontface="italic")+
    theme(
...
apoptosis_plot<-specific_genes%>%
  ...
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem), width=0.1, linetype="solid", color="black", position=position_dodge(0.1), size=0.5) + 
    ...
    ylim(5.5,6)+
    theme_classic() + 
    geom_text(x=1.5, y=5.5, label="N=103 genes", size=4, fontface="italic")+
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=14),
      axis.text=element_text(size=12, color="black"), 
...
anhydrase_plot<-specific_genes%>%
  ...
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem), width=0.1, linetype="solid", color="black", position=position_dodge(0.1), size=0.5) + 
    ...
    ylim(5,7)+
    theme_classic() + 
    geom_text(x=1.5, y=5, label="N=17 genes", size=4, fontface="italic")+
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=14),
      axis.text=element_text(size=12, color="black"), 
...
ammonium_plot<-specific_genes%>%
  ...
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem), width=0.1, linetype="solid", color="black", position=position_dodge(0.1), size=0.5) + 
    ...
    ylim(5,7)+
    theme_classic() +
    geom_text(x=1.5, y=5, label="N=5 genes", size=4, fontface="italic")+
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=14),
      axis.text=element_text(size=12, color="black"), 
...
glucose_plot<-specific_genes%>%
  ...
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem), width=0.1, linetype="solid", color="black", position=position_dodge(0.1), size=0.5) + 
    ...
    ylim(5.25,6.5)+
    theme_classic() + 
    geom_text(x=1.5, y=5.25, label="N=3 genes", size=4, fontface="italic")+
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=14),
      axis.text=element_text(size=12, color="black"), 
...
glutathione_plot<-specific_genes%>%
    ...
    ylim(5,8)+
    theme_classic() + 
    geom_text(x=1.5, y=5, label="N=3 genes", size=4, fontface="italic")+
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=14),
      axis.text=element_text(size=12, color="black"), 
...
glycogen_plot<-specific_genes%>%
  ...
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem), width=0.1, linetype="solid", color="black", position=position_dodge(0.1), size=0.5) + 
    ...
    ylim(5.25,6.25)+
    theme_classic() + 
    geom_text(x=1.5, y=5.25, label="N=5 genes", size=4, fontface="italic")+
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=14),
      axis.text=element_text(size=12, color="black"), 
...
communication_plot<-specific_genes%>%
  ...
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem), width=0.1, linetype="solid", color="black", position=position_dodge(0.1), size=0.5) + 
    ...
    ylim(5,6)+
    theme_classic() + 
    geom_text(x=1.5, y=5, label="N=6 genes", size=4, fontface="italic")+
    theme(
      legend.position="none",
      axis.title=element_text(face="bold", size=14),
      axis.text=element_text(size=12, color="black"), 
...
gene_plots<-plot_grid(carb_plot2, glucose_plot2, anhydrase_plot2, communication_plot2, ammonium_plot, atpase_plot,  glutathione_plot, apoptosis_plot,  ncol=4, nrow=2, rel_heights = c(0.5,1))
