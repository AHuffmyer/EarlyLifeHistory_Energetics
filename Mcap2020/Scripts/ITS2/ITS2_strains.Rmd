...
p2<- p2 + geom_polygon(aes(fill=lifestage)) + geom_point(size=5) + ggtitle("samples")
p2
```
...
There are 8 members of the community that shift by lifestage, 5 in clade C and 1 in clade D.  
