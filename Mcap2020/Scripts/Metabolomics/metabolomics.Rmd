                                       ...
                                       if_else(Lifestage == "Larvae1", "38", 
                                               ...
                                               if_else(Lifestage=="Larvae3", "93", 
                                                       ...
                                                       if_else(Lifestage == "Larvae5", "183 larvae", 
                                                               ...
                                                               if_else(Lifestage == "Recruit1", "183 polyp", 
                                                                       if_else(Lifestage == "Recruit2", "231 polyp", 
                                                                               if_else(Lifestage =="Recruit1plug", "183 recruit", 
                                                                                       if_else(Lifestage == "Recruit2plug", "231 recruit", 
                                                                                               if_else(Lifestage == "Recruit3plug", "255 recruit", "NA"))))))))))))))

data$HPF<-fct_relevel(data$HPF, "1", "5", "38", "65", "93", "163", "183 larvae", "183 polyp", "183 recruit", "231 larvae", "231 polyp", "231 recruit", "255 recruit")
```
