...
#Will need to make a manual legend for this in illustrator 

ggsave("Mcap2020/Figures/Respiration/Combined_Metrics.png", combined_plot, dpi=300, w=5, h=5, units="in")
```
