...
#genes increasing: carb and lipid metabolism, transmembrane transport
#genes mid: carb and lipid metabolism, signaling
...
file3<-read_csv("Mcap2020/Data/Integration/RelativeChange/genes_relchange.csv")%>%
  mutate(Pattern=if_else(Pattern=="Decreasing", "Amino acid and steroid metabolism", 
                         if_else(Pattern=="Increasing", "Carbohydrate and lipid metabolism, transmembrane transport", 
                                 if_else(Pattern=="Mid", "Carbohydrate and lipid metabolism, signaling", "NA"))))%>%
  ...
  mutate(category=if_else(variable=="Bacterial Alpha Diversity", "Microbiome Diversity", 
                          if_else(variable=="Symbiont Alpha Diversity", "Microbiome Diversity", 
                                  if_else(variable=="Amino acid and steroid metabolism", "Molecular Response", 
                                          if_else(variable=="Carbohydrate and lipid metabolism, transmembrane transport", "Molecular Response",
                                                  if_else(variable=="Carbohydrate and lipid metabolism, signaling", "Molecular Response",
