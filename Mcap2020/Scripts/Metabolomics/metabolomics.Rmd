...
```{r}
data <- data %>% 
  gather(Sample, IonCounts, 64:109)
...
data<-data%>%
  filter(!(Lifestage=="Larvae2"))%>%
  filter(!(Lifestage=="Larvae4"))%>%
  filter(!(Lifestage=="Larvae6"))

#add development column with larger categories 
data<-data%>%
  mutate(Development = if_else(Lifestage == "Egg", "Embryo", 
...
data$HPF<-fct_relevel(data$HPF, "1", "5", "38", "93", "183 larvae", "183 recruit", "183 recruit plug", "231 recruit", "231 recruit plug")
```
...
pcaPlot1<-ggplot2::autoplot(scaled.pca, data=data_pca, frame.colour="HPF", loadings=FALSE,  colour="HPF", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=FALSE, loadings.label.size=5, loadings.label.vjust=-1, size=5) + 
...
pcaPlot1a<-ggplot2::autoplot(scaled.pca, data=data_pca, frame.colour="Development", loadings=FALSE,  colour="Development", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=FALSE, loadings.label.size=5, loadings.label.vjust=-1, size=5) + 
  #scale_colour_manual(values=c("orange", "darkgray", "purple")) +
  #scale_fill_manual(values=c("orange", "darkgray", "purple")) + 
  theme_classic()+
  #xlim(-0.75,0.75)+
...
data_neg$HPF<-fct_relevel(data_neg$HPF, "1", "5", "38", "93", "183 larvae", "183 recruit", "183 recruit plug", "231 recruit", "231 recruit plug", "255 recruit plug")
```
...
pcaPlot1_neg<-ggplot2::autoplot(scaled.pca.neg, data=data_pca_neg, frame.colour="HPF", loadings=FALSE,  colour="HPF", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=FALSE, loadings.label.size=5, loadings.label.vjust=-1, size=5) + 
  #scale_colour_manual(values=c("orange", "darkgray", "purple")) +
  #scale_fill_manual(values=c("orange", "darkgray", "purple")) + 
  theme_classic()+
  #xlim(-0.75,0.75)+
...
pcaPlot1a_neg<-ggplot2::autoplot(scaled.pca.neg, data=data_pca_neg, frame.colour="Development", loadings=FALSE,  colour="Development", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=FALSE, loadings.label.size=5, loadings.label.vjust=-1, size=5) + 
  #scale_colour_manual(values=c("orange", "darkgray", "purple")) +
  #scale_fill_manual(values=c("orange", "darkgray", "purple")) + 
  theme_classic()+
  #xlim(-0.75,0.75)+
...
```{r}
scaled.pca<-prcomp(data_pca_full[c(5:99)],scale=TRUE, center=TRUE) 

fviz_eig(scaled.pca)

pcaPlot_full<-ggplot2::autoplot(scaled.pca, data=data_pca_full, frame.colour="HPF", loadings=FALSE,  colour="HPF", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=FALSE, ,loadings.label.size=5, loadings.label.vjust=-1, size=5) + 
...
pcaPlot_full2<-ggplot2::autoplot(scaled.pca, data=data_pca_full, frame.colour="Development", loadings=FALSE,  colour="Development", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=FALSE, ,loadings.label.size=5, loadings.label.vjust=-1, size=5) + 
  #scale_colour_manual(values=c("#80CDC1", "#80CDC1", "#80CDC1")) +
  #scale_fill_manual(values=c("#80CDC1", "#80CDC1", "#80CDC1")) + 
  theme_classic()+
  #xlim(-0.75,0.75)+
...
pdf("Mcap2020/Figures/Metabolomics/PLSDA_Lifestage.pdf")
plotIndiv(MyResult.plsda, ind.names = FALSE, legend=TRUE,ellipse = TRUE, title="PLS-DA, Lifestage")
dev.off() 
```
...
pdf("Mcap2020/Figures/Metabolomics/PLSDA_Development.pdf")
