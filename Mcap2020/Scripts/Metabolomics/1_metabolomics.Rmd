...
timepoint_plot3<- metabolites %>%
  filter(compound %in% vip_list)%>%
  filter(compound %in% c("Norvaline", "Guanine", "GMP", "Carbamoyl phosphate", "Glutaryl-carnitine", "Hippuric acid", "Glucuronic acid", "L-Octanoylcarnitine", "Glutamine", "Coenzyme A", "1-Methylimidazole acetic acid", "5- Methylthioadenosine", "Porphobilinogen", "4-Aminobutyrate", "5-methylthioadenosine"))%>%
...
Fix 5-methylthioadenosine - duplicate? 

Take VIP list and input for metaboanalyst? See what pathways are enriched for things that change across development? 

Correlation network between DEG genes and VIP metabolites? Then annotate correlated things? 

## Plot VIP concentration across life stages in complex heatmap 

Y = metabolite 
X = lifestage
color = concentration 
dend = distance of compound and conentration for each life stage 
