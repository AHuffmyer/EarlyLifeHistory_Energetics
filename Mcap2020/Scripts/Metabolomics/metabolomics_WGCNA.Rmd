...
cmpd.vec<-c("Methylimidazole acetic acid","Iodotyrosine","Phenylacetylglycine","Arginyl-Valine","Glutamylarginine")
mSet<-Setup.MapData(mSet, cmpd.vec);
mSet<-CrossReferencing(mSet, "name");
mSet<-CreateMappingResultTable(mSet)
mSet<-PerformDetailMatch(mSet, "Methylimidazole acetic acid");
mSet<-GetCandidateList(mSet);
mSet<-SetCandidate(mSet, "Methylimidazole acetic acid", "Methylimidazoleacetic acid");
...
mSet<-PlotEnrichPieChart(mSet, "ora", "ora_pie_2_", "png", 72)
```
