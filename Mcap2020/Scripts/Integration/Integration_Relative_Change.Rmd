...
file2<-read_csv("Mcap2020/Data/Integration/RelativeChange/cells_relchange.csv")%>%
  dplyr::select(!group)%>%
  rename("Symbiont Density"="sym_density_ind", "Symbiont Cells per mm2"="sym_density_mm")%>%
...
color_keys<-c("Energy Demand"="black", "Photosynthetic Capacity"="orange", "Microbiome Diversity"="darkgray", "Molecular Response"="red", "Metabolomic Response"="blue")
