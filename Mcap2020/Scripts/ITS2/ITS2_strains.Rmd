...
In rarefication 9 OTUs were removed because they were no longer present in any sample after random subsampling. 
...
p2b<- p2b + geom_polygon(aes(fill=lifestage), color="black") + geom_point(aes(color=lifestage), size=4) + ggtitle("PCoA")
p2b
```
