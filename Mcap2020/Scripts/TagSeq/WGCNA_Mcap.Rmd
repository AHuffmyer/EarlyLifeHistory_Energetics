...
gPCAdata<-gPCAdata%>%
   mutate(lifestage = factor(lifestage, levels = c("1_Egg", "2_Embryo", "3_Larvae1", "4_Larvae2", "5_Larvae3", "6_Larvae4", "7_Larvae6", "8_MetamorposedRecruit2", "9_CalcifyingRecruit1", "10_CalcifyingRecruit2")))
levels(gPCAdata$lifestage)
...
allgenesfilt_PCA_visual <- 
  ...
  xlab(paste0("PC1: ",percentVar[1],"% variance")) +
  ylab(paste0("PC2: ",percentVar[2],"% variance")) +
  scale_shape_manual(name="Lifestage", values = c("1_Egg"=17, "2_Embryo"=16, "3_Larvae1"=15, "4_Larvae2"=17,"5_Larvae3"=15, "6_Larvae4"=16,"7_Larvae6"=17,"8_MetamorposedRecruit2"=16, "9_CalcifyingRecruit1"=15, "10_CalcifyingRecruit2"=16), labels=c("Egg (1 hpf)", "Embryo (5 hpf)", "Embryo (38 hpf)", "Embryo (65 hpf)", "Larvae (93 hpf)", "Larvae (163 hpf)", "Larvae (231 hpf)", "Metamorphosed Polyp (231 hpf)", "Attached Recruit (183 hpf)", "Attached Recruit (231 hpf)")) +
  scale_colour_manual(name="Lifestage", values = c("1_Egg"="#8C510A", "2_Embryo"="#DFC27D", "3_Larvae1"="#DFC27D", "4_Larvae2"="#DFC27D", "5_Larvae3"="#80CDC1", "6_Larvae4"="#80CDC1", "7_Larvae6"="#80CDC1", "8_MetamorposedRecruit2"="#003C30", "9_CalcifyingRecruit1"="#BA55D3", "10_CalcifyingRecruit2"="#BA55D3"), labels=c("Egg (1 hpf)", "Embryo (5 hpf)", "Embryo (38 hpf)", "Embryo (65 hpf)", "Larvae (93 hpf)", "Larvae (163 hpf)", "Larvae (231 hpf)", "Metamorphosed Polyp (231 hpf)", "Attached Recruit (183 hpf)", "Attached Recruit (231 hpf)")) +
  #xlim(-40,40)+ 
  #ylim(-40,40)+
  coord_fixed()+
...
expression_plots<-plot_MEs%>%
  ...
  scale_x_discrete(name="", labels=c("Egg_1hpf", "Embryo_5hpf", "Embryo_38hpf", "Embryo_65hpf", "Larvae_93hpf", "Larvae_163hpf", "Larvae_231hpf", "MetamorphosedPolyp_231hpf", "AttachedRecruit_183hpf", "AttachedRecruit_231hpf"), limits=time_point_order) +
  #ylim(-0.5,1) +
