...
# **Plot all stages together on one plot**  
...
ggsave(filename="Mcap2020/Figures/TagSeq/GOSeq/GOenrich_all_BP.png", plot=GO_all.BP, dpi=300, width=16, height=24, units="in")
```
