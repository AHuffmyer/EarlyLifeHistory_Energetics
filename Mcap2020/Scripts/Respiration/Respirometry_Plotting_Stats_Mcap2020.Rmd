...
r_plot<-PRdf %>%
    ...
    geom_point(aes(fill=Lifestage, group=group), pch = 21, size=4, position = position_dodge(1)) + 
    xlab("Hours Post-Fertilization") + 
    scale_fill_manual(name="Lifestage", values=c("#80CDC1","#003C30"))+
    scale_color_manual(name="Lifestage", values=c("#80CDC1","#003C30"))+
...
Rmodel1<-lmer(R.nmol.org.min~group + (1|Run), data=PRdf) #run nested within day
