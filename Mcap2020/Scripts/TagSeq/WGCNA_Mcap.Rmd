...
```{r}
specific_genes<-rbind(carbanhyd_genes, glycsyn_genes, ammontr_genes, glutperox_genes, atpase_genes, glucosehomeo_genes, apoptosis_genes, communication_genes, carbs_genes, fattyacid_genes, allcarbs_genes, gluctr_genes, lipids_genes)
```
