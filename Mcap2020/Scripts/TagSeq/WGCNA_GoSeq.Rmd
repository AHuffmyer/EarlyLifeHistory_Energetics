...
ggsave(filename="Mcap2020/Figures/TagSeq/GOSeq/GOenrich_all_BP.png", plot=GO_all.BP, dpi=300, width=35, height=35, units="in")
```
...
ggsave(filename="Mcap2020/Figures/TagSeq/GOSeq/GOenrich_all_MF.png", plot=GO_all.MF, dpi=300, width=49, height=49, units="in")
```
Note that there were no enriched categories at 65 hpf so it is not displayed in this plot.  
