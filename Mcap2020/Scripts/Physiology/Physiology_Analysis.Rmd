...
```{r}
size$volume <- (4/3) * pi * (0.5*size$width)^2 * (0.5*size$length)
```
...
target_plots_legend<-plot_grid(symb_plot3b, recruit_size_plot_mean2, legend, rel_widths = c(1,0.5,0.5), rel_heights=c(1,0.8,1), ncol=3, nrow=1, align="h", axis = "b", labels=c("A", "B", ""))
