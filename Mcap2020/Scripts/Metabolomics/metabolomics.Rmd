  ...
  mutate(Development = if_else(Lifestage == "Egg", "Egg", 
                               if_else(Lifestage =="Embryo", "Embryo", 
                                       if_else(Lifestage == "Larvae1", "Embryo", 
                                               if_else(Lifestage == "Larvae2", "Larvae",
...
pdf("Mcap2020/Figures/Metabolomics/CIM_Timepoint.pdf")
cim(MyResult.plsda, mapping="Y", row.names = metabolites$HPF, xlab = "Metabolites", ylab="Timepoint", margins=c(10,7))
dev.off()
```
...
pdf("Mcap2020/Figures/Metabolomics/CIM_Development.pdf")
cim(MyResult.plsda.D, row.names = metabolites$Development, mapping="Y", xlab = "Metabolites", ylab="Developmental Group", margins=c(10,10))
dev.off()
```
...
pdf("Mcap2020/Figures/Metabolomics/Timepoint_VIP.pdf")
Timepoint_VIP_1 %>%
  arrange(VIP) %>%
  ggplot( aes(x = VIP, y = reorder(Metabolite,VIP,sum))) +
  geom_point() +
...
pdf("Mcap2020/Figures/Metabolomics/Development_VIP.pdf")
Develop_VIP_1 %>%
  arrange(VIP) %>%
  ggplot( aes(x = VIP, y = reorder(Metabolite,VIP,sum))) +
  geom_point() +
...
pdf("Mcap2020/Figures/Metabolomics/EggsEmbryo_VIP.pdf")
EvE_VIP_1 %>%
  arrange(VIP) %>%
  ggplot( aes(x = VIP, y = reorder(Metabolite,VIP,sum))) +
  geom_point() +
...
pdf("Mcap2020/Figures/Metabolomics/EmbryoLarvae_VIP.pdf")
EvL_VIP_1 %>%
  arrange(VIP) %>%
  ggplot( aes(x = VIP, y = reorder(Metabolite,VIP,sum))) +
  geom_point() +
...
pdf("Mcap2020/Figures/Metabolomics/LarvaeMetamorphosed_VIP.pdf")
LvM_VIP_1 %>%
  arrange(VIP) %>%
  ggplot( aes(x = VIP, y = reorder(Metabolite,VIP,sum))) +
  geom_point() +
...
pdf("Mcap2020/Figures/Metabolomics/LarvaeCalcifying_VIP.pdf")
LvC_VIP_1 %>%
  arrange(VIP) %>%
  ggplot( aes(x = VIP, y = reorder(Metabolite,VIP,sum))) +
  geom_point() +
...
pdf("Mcap2020/Figures/Metabolomics/MetamorphosedCalcifying_VIP.pdf")
MvC_VIP_1 %>%
  arrange(VIP) %>%
  ggplot( aes(x = VIP, y = reorder(Metabolite,VIP,sum))) +
  geom_point() +
