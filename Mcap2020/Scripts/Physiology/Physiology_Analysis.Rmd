...
calculate_volume <- function(group, length, width) {
  case_when(
    group %in% c("Egg", "Embryo") ~ (4/3) * pi * (length/2)^3,
...
ggsave(plot=size_plot_mean, "Mcap2020/Figures/Physiology/size_mean.png",height=8, width=8)
ggsave(plot=size_plot_mean, "Mcap2020/Figures/Physiology/size_mean.pdf",height=8, width=8)
```
