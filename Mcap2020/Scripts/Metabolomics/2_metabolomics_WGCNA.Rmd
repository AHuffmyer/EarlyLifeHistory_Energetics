...
sample_metadata <- read.csv("Mcap2020/Data/Metabolomics/metabolomics_sample_metadata.csv") 
...
#  group_by(Module) %>%
  ...
  scale_colour_manual(name="Lifestage", values=c("#8C510A", "#DFC27D","#80CDC1", "#003C30", "#BA55D3")) + 
  xlab("") + #Axis titles
