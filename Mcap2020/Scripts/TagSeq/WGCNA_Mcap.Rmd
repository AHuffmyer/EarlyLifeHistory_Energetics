...
ggsave("Mcap2020/Figures/TagSeq/genes_lifestagePCA.png", genesPCA, width=6, height=5, dpi=300)
```
...
write_csv(table, "Mcap2020/Output/TagSeq/genes_per_module.csv")
```
...
plot_MEs<-Strader_MEs%>%
  gather(., key="Module", value="Mean", ME1:ME18)

write_csv(plot_MEs, "Mcap2020/Output/TagSeq/WGCNA_eigengene_expression.csv")
...
# **Output files for GOMWU functional enrichment** 
