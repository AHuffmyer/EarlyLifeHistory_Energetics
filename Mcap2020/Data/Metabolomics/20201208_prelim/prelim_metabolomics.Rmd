...
write_csv(normalized_counts_pos_neg, file="normalized_counts_pos_neg.csv")
...
ggsave("prelimPCA_full.pdf", plot=pcaPlot_full, height=8, width=10, units = c("in"), dpi=300) #output figure
```
...
pcaplots<-plot_grid(pca_pos, pca_neg, pcaPlot_full, labels = c("Positive", "Negative", "Combined"), ncol=3, nrow=1, rel_widths = c(0.8, 0.8, 1), label_size = 20, label_x = 0.1)

ggsave(filename="All_PCAs.pdf", plot=pcaplots, dpi=300, width=20, height=5, units="in")
```
