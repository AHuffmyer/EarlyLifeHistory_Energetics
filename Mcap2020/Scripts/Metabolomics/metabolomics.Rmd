...
X$HPF<-fct_relevel(X$HPF, "Egg (1 hpf)", "Embryo (5 hpf)", "Embryo (38 hpf)", "Embryo (65 hpf)", "Larvae (93 hpf)", "Larvae (163 hpf)", "Larvae (183 hpf)", "Metamorphosed Polyp (183 hpf)", "Attached Recruit (183 hpf)", "Larvae (231 hpf)", "Metamorphosed Polyp (231 hpf)", "Attached Recruit (231 hpf)", "Attached Recruit (255 hpf)")
...
pdf("Mcap2020/Figures/Metabolomics/PLSDA_Lifestage.pdf", width=8, height=6)
plotIndiv(MyResult.plsda, col=lifestage_cols, ind.names = FALSE, legend=FALSE, legend.title = "Lifestage", ellipse = TRUE, title="", pch=pch.input, style = "graphics", centroid=FALSE, point.lwd = 2, cex=2)
dev.off() 
...
X$Development<-fct_relevel(X$Development, "Egg", "Embryo", "Larvae", "Metamorphosed Polyp", "Attached Recruit")

levels(X$Development)
...
develop_cols<-c("#BA55D3", "#8C510A", "#DFC27D", "#80CDC1", "#003C30")
...
For development, we get the most information from 4 of the 5 components (larvae and metamorphosed polyps overlap).   
...
Analyses are continued in the metabolomics_WGCNA.Rmd script.  