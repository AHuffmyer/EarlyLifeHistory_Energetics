...
ggsave("Mcap2020/Figures/Respiration/Combined_Metrics_PR.png", combined_full, dpi=300, w=7, h=7, units="in")
```
...
pr_change<-PRdf%>%
  ...
  mutate(GP_change=((mean_GP-dplyr::first(mean_GP))/abs(dplyr::first(mean_GP))), 
         R_change=((mean_R-dplyr::first(mean_R))/abs(dplyr::first(mean_R))), 
