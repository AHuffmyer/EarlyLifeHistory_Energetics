...
```{r}
apoptosis<-c("g11795", "adi2mcaRNA13549_R0", "adi2mcaRNA18229_R0", "adi2mcaRNA1941_R1", "adi2mcaRNA19725_R7")
...
```{r}
specific_genes<-rbind(carbanhyd_genes, glycsyn_genes, sugartr_genes, ammontr_genes, acetylcarb_genes, glutperox_genes, solutetr_genes, atpase_genes, glucosehomeo_genes, apoptosis_genes)
```
...
gene_plots<-plot_grid(anhydrase_plot, acetyl_plot, ammonium_plot, atpase_plot, glucose_plot, glutathione_plot, glycogen_plot, solute_plot, sugar_plot, apoptosis_plot, ncol=5, nrow=2, align="h")
                      
ggsave(filename="Mcap2020/Figures/TagSeq/gene_expression_class.pdf", plot=gene_plots, dpi=300, width=12, height=8, units="in")
```
