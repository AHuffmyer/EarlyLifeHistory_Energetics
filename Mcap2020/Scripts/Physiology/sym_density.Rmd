...
symb_plot<-df %>%
    ggplot(., aes(x = code, y = cells.ind, fill = code)) +
    ...
    geom_text(label="AB", x=4, y=4100, size=5, color="black")+ #larvae 2
    geom_text(label="AB", x=5, y=4100, size=5, color="black")+ #larvae 3
    geom_text(label="AB", x=6, y=4100, size=5, color="black")+ #larvae 4
    geom_text(label="BC", x=7, y=4500, size=5, color="black")+ #larvae 5
    geom_text(label="CD", x=8, y=6500, size=5, color="black")+ #recruit 1
    geom_text(label="D", x=9, y=6500, size=5, color="black")+ #larvae6
