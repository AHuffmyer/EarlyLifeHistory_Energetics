...
ggsave(filename=paste0("Mcap2020/Figures/TagSeq/GenomeV3/GOSeq/GOenrich_AllPatterns_Symbiosis.pdf"), plot=GO.plot.sym, dpi=300, width=13, height=18, units="in")
...
ggsave(filename="Mcap2020/Figures/TagSeq/GenomeV3/ontogeny_patterns_expression.pdf", plot=pattern_plots, dpi=50 , width=16, height=6, units="in")
```
