...
myResult.splsda.final_T <- splsda(X, Y, ncomp = 10, keepX=select.keepX) #use the number of components to keep based on optimization from above  
...
myResult.splsda.final_D <- splsda(X, Y, ncomp = 5, keepX=select.keepX) #use the number of components to keep based on optimization from above  
